...
//int mirrorMapPixelIndex = (int)texY * texture.textureWidth * texture.textureChannels + (int)texX * texture.textureChannels;
//
//float x = texture.normalTexturData[mirrorMapPixelIndex] / 255.0f;
//float y = texture.normalTexturData[mirrorMapPixelIndex + 1] / 255.f;
//float z = texture.normalTexturData[mirrorMapPixelIndex + 2] / 255.f;
//
////CoordinateStruct hitNormal = { x, y, z };
//hitNormal = hitNormal * 2 - 1;
...
//float ks = texture.specularTexturData[mirrorMapPixelIndex] / 255.0f;
//
////CoordinateStruct hitColor = calculatePhongLight(curPointInGlobal, /*hitNormal*/ oldNormal, CameraGlobalCoordinates, lightnings, ks);
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
